...
//               positive manifold. The stable part of the manifold will go
...
//function call:
// auto arrays = Generate_Positive_Manifolds( Initial_Conditions,  Tp,  mu,  n);
...
std::pair<std::vector<std::vector<double>>, std::vector<std::vector<double>>> Generate_Positive_Manifolds(const std::vector<double>& x0, double Tp, double mu, int n) {
